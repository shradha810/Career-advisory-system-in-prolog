...
careeradvisory :- 
    write('Welcome to Career Advisory System.'),nl,fail.
careeradvisory :-
...
printmsg(job) :-
	write('Based on the responses to the various questions asked, you should go for Corporate Job.'), nl.
printmsg(phd) :-
	write('Based on the responses to the various questions asked, you should go for PhD.'), nl.
printmsg('startup') :-
	write('Based on the responses to the various questions asked, you should go for Startup.'), nl.
printmsg('teaching') :-
	write('Based on the responses to the various questions asked, you should go for Teaching.'), nl.
printmsg('notfound'):-
  write('Based on the responses to the various questions asked, no career choice could be found.'),nl.